...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            dragDropStr: "<span><b>可以直接拖曳文件到这里</b></span>",
            uploadStr:"上传",
            abortStr: "终止",
            cancelStr: "取消",
            deletelStr: "删除",
            doneStr: "完成",
            multiDragErrorStr: "不允许上传多个文件.",
            extErrorStr: "上传文件类型错误",
            duplicateErrorStr: "文件已存在",
            sizeErrorStr: "文件大小超出限制 ",
            uploadErrorStr: "上传出错",
            maxFileCountErrorStr: " 超出最大上传文件数目",
            downloadStr: "下载",
            customErrorKeyStr: "上传出错啦...",
            showQueueDiv: false,
            statusBarWidth: 400,
            dragdropWidth: 400,
            showPreview: false,
