...
app_field = appBookshelf.Model.extend({
...
app_fields = appBookshelf.Collection.extend({
	model:app_field
});

module.exports = {
	app_field: appBookshelf.model('app_field', app_field),
	app_fields: appBookshelf.collection('app_fields', app_fields)
};
