...
app_setting = appBookshelf.Model.extend({
...
app_settings = appBookshelf.Collection.extend({
	model:app_setting
});

module.exports = {
	app_setting:appBookshelf.model('app_setting',app_setting),
	app_settings:appBookshelf.collection('app_settings',app_settings)
};
