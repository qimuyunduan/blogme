...
webpage = appBookshelf.Model.extend({
...
webpages = appBookshelf.Collection.extend({
	model:webpage
});

module.exports = {
	webpage: appBookshelf.model('webpage', webpage),
	webpages: appBookshelf.collection('webpages', webpages)
};
