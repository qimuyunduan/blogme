...
param = appBookshelf.Model.extend({
...
params = appBookshelf.Collection.extend({
	model:param
});

module.exports = {
	param: appBookshelf.model('param', param),
	params: appBookshelf.collection('params', params)
};
