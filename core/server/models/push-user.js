...
push_user = appBookshelf.Model.extend({
...
push_users = appBookshelf.Collection.extend({
	model:push_user
});

module.exports = {
	push_user: appBookshelf.model('push_user', push_user),
	push_users: appBookshelf.collection('push_users', push_users)
};
