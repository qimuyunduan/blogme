...
setting = appBookshelf.Model.extend({
...
settings = appBookshelf.Collection.extend({
	model:setting
});

module.exports = {
	setting: appBookshelf.model('setting', setting),
	settings: appBookshelf.collection('settings', settings)
};
