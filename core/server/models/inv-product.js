...
inv_product = appBookshelf.Model.extend({
...
inv_products = appBookshelf.Collection.extend({
	model:inv_product
});

module.exports = {
	inv_product: appBookshelf.model('inv_product', inv_product),
	inv_products: appBookshelf.collection('inv_products', inv_products)
};
