...
dict_city = appBookshelf.Model.extend({
...
dict_citys = appBookshelf.Collection.extend({
	model:dict_city
});

module.exports = {
	dict_city: appBookshelf.model('dict_city', dict_city),
	dict_citys: appBookshelf.collection('dict_citys', dict_citys)
};
