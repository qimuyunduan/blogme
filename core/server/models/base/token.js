...
Basetoken = appBookshelf.Model.extend({
    ...
    destroyByUser: function destroyByUser(options) {
        ...
        return Promise.reject(new errors.NotFoundError('errors.models.base.token.noUserFound'));
    },
    ...
    destroyByToken: function destroyByToken(options) {
        ...
        return Promise.reject(new errors.NotFoundError('errors.models.base.token.tokenNotFound'));
    }
});
