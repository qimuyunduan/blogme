...
user_t = appBookshelf.Model.extend({
...
users_t = appBookshelf.Collection.extend({
	model:user_t
});

module.exports = {
user_t: appBookshelf.model('user_t',user_t ),
users_t: appBookshelf.collection('users_t',users_t )
};
