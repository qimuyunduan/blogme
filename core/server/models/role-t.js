...
role_t = appBookshelf.Model.extend({
...
roles_t = appBookshelf.Collection.extend({
	model:role_t
});

module.exports = {
	role_t: appBookshelf.model('role_t', role_t),
	roles_t: appBookshelf.collection('roles_t', roles_t)
};
