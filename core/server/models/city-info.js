...
city_info = appBookshelf.Model.extend({
...
city_infos = appBookshelf.Collection.extend({
	model:city_info
});

module.exports = {
	city_info: appBookshelf.model('city_info', city_info),
	city_infos: appBookshelf.collection('city_infos', city_infos)
};
