...
populate = function (options) {
    logInfo('errors.data.fixtures.populatingPermissions');
...
to003 = function (options) {
    ...
    logInfo('errors.data.fixtures.upgradingPermissions');
    ...
    return models.Permissions.forge().fetch().then(function (permissions) {
        logInfo('errors.data.fixtures.removingOldPermissions');
