...
pagination = function (options) {
    ...
    if (!_.isObject(this.pagination) || _.isFunction(this.pagination)) {
        return errors.logAndThrowError('warnings.helpers.pagination.invalidData');
    }
    ...
    if (_.isUndefined(this.pagination.page) || _.isUndefined(this.pagination.pages) ||
        ...
        return errors.logAndThrowError('warnings.helpers.pagination.valuesMustBeDefined');
    }
    ...
    if ((!_.isNull(this.pagination.next) && !_.isNumber(this.pagination.next)) ||
        ...
        return errors.logAndThrowError('warnings.helpers.pagination.nextPrevValuesMustBeNumeric');
    }

    if (!_.isNumber(this.pagination.page) || !_.isNumber(this.pagination.pages) ||
        !_.isNumber(this.pagination.total) || !_.isNumber(this.pagination.limit)) {
        return errors.logAndThrowError('warnings.helpers.pagination.valuesMustBeNumeric');
    }
